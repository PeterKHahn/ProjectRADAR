...
public class BoardTest {
  ...
  private static ChunkMap oneObstacle;
  private static ChunkMap multObstacles;

  @Before
  public void setup() {
    emptyChunks = new ChunkMap(10, 10, 1);
    oneObstacle = new ChunkMap(10, 10, 1);
    oneObstacle.addStatic(new Obstacle("1", new Vector(5, 5), 1));
    multObstacles = new ChunkMap(10, 10, 1);
    multObstacles.addStatic(new Obstacle("1", new Vector(2, 2), 1));
    multObstacles.addStatic(new Obstacle("2", new Vector(7, 7), 2));
  }
