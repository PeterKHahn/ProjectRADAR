...
public class Board {
     ...
     * the game.
     *
     * @param chunks A ChunkMap containing all entities in the game.
     */
     ...
     *
     * @param obstacle The obstacle we are looking at.
     * @param start    The start position of the line segment.
     * @param dir      The direction of the line segment that also defines the end of the
     *                 line segment.
     ...
     *
     * @param pos     The Position to add edges to. Assumes that this position is not
     *                inside of any obstacle.
     * @param reverse Whether or not to also add edges from other positions with the
     *                given position.
     */
     ...
     *
     * @param pos The position that the player is at.
     * @param dir The direction that the player wants to go in.
    ...
    public Position getEdgePosition(Position pos, Vector dir) {
        ...
        if (edgePos == null) {
            return center; // FIXME added a temporary fix for a null pointer that was throwing
        }
        return edgePos;
    }
