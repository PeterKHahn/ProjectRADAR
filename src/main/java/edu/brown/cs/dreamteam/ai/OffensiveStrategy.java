 ...
 *   1. Choose the closest encountered player whose hit range is smaller than
 *   AI's hit range as the target.
 *   2. Move towards the target's current position to get within hit range
 *   3. Predict the other player's movements to aim and attack at the optimal
 *   direction to hit the player
 *   4. If successfully killed the target, collect all target's better-quality
 *   items
