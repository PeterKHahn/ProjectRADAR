...
| Date                  | Integrations                      |
|-------------------    |---------------------------------  |
| April 7               | <ul><li>Game logic:<ul><li>can send networking player status updates</li><li>can send AI player all players' statues (position, health, materials)</li><li>can produce game logs (player statuses at every frame or second, or whatever is feasible)</li></ul></li><li>Frontend:<ul><li>all pages' can be rendered</li><li>can render players on screen according to client statuses from networking</li></ul></li><li>Networking:<ul><li>can receive client statuses from game logic and AI</li><li>can pass on client statuses to frontend</li><li>can generate game room URLs</li><li>has all game pages' URLs' post/get Spark requests set up</li></ul></li><li>AI:<ul><li>can receive hitbox, hurtbox, player statuses from game logic</li><li>position prediction and shortest distance walking models are completed, if not trained</li><li>can send client status updates to networking</li></ul></li></ul> |
